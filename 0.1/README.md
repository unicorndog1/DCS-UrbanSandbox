...
# DCS Lebanon CSAR/SAR Mission System

This mission uses Civilian Objects but will substitue units if it's not present (like the "yellow ambulance")

A comprehensive helicopter rescue and combat mission system for DCS World, featuring various mission types including search and rescue, VIP transport, vehicle chases, and more.
...
Mission system designed for intense helicopter combat and rescue operations in Lebanon and surrounding areas.

Enjoy your missions, pilot! 🚁
