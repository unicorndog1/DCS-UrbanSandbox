...
# Use Alfa DTM properties instead of calculated values
$maxRoadVelocityMps = 61.1111
$maxAcceleration = 10.225926
$enginePower = 420
...
GT.chassis = {
    ...
    engineMinRPM = 700,
    engineMaxPowerRPM = 8500,
    engineMaxRPM = 11500,
    gearRatios = { -5.03, 0.0, 5.49, 4.49, 3.49, 2.49, 1.49, 1.49},
    mainGearRatio = 3.50,
